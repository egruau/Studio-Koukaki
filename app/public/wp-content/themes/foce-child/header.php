	...
	<header class="header">
        ...
        <nav class="header__nav">
            <ul class="header__nav__menu">
                ...
                <li class="header__nav__menu__link header__nav__menu__link-story"><a href="#story">Histoire</a></li>
                <li class="header__nav__menu__link header__nav__menu__link-characters"><a href="#characters">Personnages</a></li>
                <li class="header__nav__menu__link header__nav__menu__link-place"><a href="#place">Lieu</a></li>
                <li class="header__nav__menu__link header__nav__menu__link-studio"><a href="#studio">Studio Koukaki</a></li>
            </ul>
        </nav>
	</header><!-- #masthead -->
