...
<main id="primary" class="site-main">
    ...
    <section id="story" class="story fadeIn">
        ...
        <article id="place">
            ...
            <div class="clouds">
                <img class="cloud big_cloud" src="<?php echo get_stylesheet_directory_uri() . '/assets/images/big_cloud.png' ?> ">
                <img class="cloud little_cloud" src="<?php echo get_stylesheet_directory_uri() . '/assets/images/little_cloud.png' ?> ">
            </div>
    ...
    <section id="studio" class="fadeIn">
        ...
        <h2> <span class="studio__title__first">Studio</span> <span class="studio__title__second">Koukaki</span> </h2>
        <div>
